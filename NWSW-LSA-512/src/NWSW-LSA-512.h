...
#define __FRAGMENTSIZE "--fragment"
...
enum Vectorization { CISC, SSE3, AVX2, AVX512, KNC_SET, ARM_SET };
...
#define DEFAULT_FRAGMENTSIZE 4000
...
#define enumVectorizationToString(value) ((value) == CISC)? __CISC : ((value) == SSE3)? __128 : ((value) == AVX2)? __256 : ((value) == AVX512)? __512 : ((value) == KNC_SET)? __KNC : __ARM
